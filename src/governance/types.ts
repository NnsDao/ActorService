...
export default interface _SERVICE {
  claim_gtc_neurons: (arg_0: Principal, arg_1: Array<NeuronId>) => Promise<Result>;
  ...
  get_full_neuron_by_id_or_subaccount: (arg_0: NeuronIdOrSubaccount) => Promise<Result_2>;
  get_monthly_node_provider_rewards: () => Promise<Result_3>;
  get_most_recent_monthly_node_provider_rewards: () => Promise<[] | [MostRecentMonthlyNodeProviderRewards]>;
  ...
  get_neuron_info_by_id_or_subaccount: (arg_0: NeuronIdOrSubaccount) => Promise<Result_4>;
  ...
  list_proposals: (arg_0: ListProposalInfo) => Promise<ListProposalInfoResponse>;
